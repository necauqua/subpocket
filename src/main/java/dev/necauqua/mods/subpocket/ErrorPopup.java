...
public final class ErrorPopup extends GuiComponent implements GuiEventListener, Widget, NarratableEntry {
    ...
    public void render(PoseStack poseStack, int mx, int my, float partialTicks) {
        ...
        lines.add(Component.translatable("gui.subpocket:it.error.title"));
        if (shiftDown) {
            for (var entry : pickingErrors.entrySet()) {
                ...
                var item = Component.literal(id).withStyle(GRAY);
                lines.add(Component.translatable("gui.subpocket:it.error.line", item));
            }
        } else {
            ...
            lines.add(Component.translatable("gui.subpocket:it.error.report"));
            lines.add(CommonComponents.EMPTY);
            lines.add(Component.translatable("gui.subpocket:it.error.desc.use_alt"));
            lines.add(CommonComponents.EMPTY);
            lines.add(Component.translatable("gui.subpocket:it.error.desc.hold_shift", shiftName));
            lines.add(Component.translatable("gui.subpocket:it.error.desc.shift_click", shiftName));
            lines.add(Component.translatable("gui.subpocket:it.error.desc.ctrl_click", ctrlName));
        }
